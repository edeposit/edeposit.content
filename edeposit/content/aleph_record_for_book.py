...
class IAlephRecordForBook(form.Schema, IImageScaleTraversable):
    """
    E-Deposit Aleph Record for Book/Preprint/Postprint
    """
    ...
    aleph_library = schema.ASCIILine (
        ...
        description = _(u'Library that Aleph refers to metadata of this Book'),
        required = True,
    )
...
class AlephRecordForBook(AlephRecordBase):
    grok.implements(IAlephRecordForBook)
